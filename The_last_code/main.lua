...
work = room{
	...
	obj = {'workspace', vway('Меня вызывают к боссу','Меня вызывают {к боссу}! Боже, что же делать...','bossroom')};
	way = {'bossroom'},
}
--директор 4
bossroom = room{
	...
	Я тяжело вздохнула... ]],
	obj = {vway('Согласиться','{Я решила согласиться помогать}^','yep'), vway('Отказаться','{Я решила отказаться помогать}','nope')};
	--way = {};
}
--продолжение 5
yep = room{
	...
	А можешь творить по ходу моей истории. А самые смелые могут прислать свои файлы игры мне на почту (адрес будет в конце игры).
...
book2 = obj{
	...
	tak = [[Вот тут как раз тот самый случай жизни... Интересно, как можно её ещё использовать, кроме как для прямому назначению...]],
